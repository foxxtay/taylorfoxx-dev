	...
	render() {
		return(
			<div className="portfolio-content">
				...
				<h1 className="wow fadeIn">DOD App</h1>
				<h2 className="wow fadeIn" data-wow-delay="0.15s">An application created to promote and create a community within the Department of Design at Winthrop University.</h2>
				<div className="header-shot wow fadeIn" data-wow-delay="0.3s">
					<div>
						<img src={ headerImg } alt="Mockup of the DOD App Being Used Showing the Messages Section" />
					</div>
				</div>
